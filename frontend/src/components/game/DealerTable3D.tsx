...
export default function DealerTable3D({
  ...
  return (
    <div className={`lg:flex-1 lg:min-h-[700px] relative flex flex-col overflow-visible bg-[#050a0d] ${isDT ? 'h-[230px] sm:h-[300px] lg:h-auto' : 'h-[240px] sm:h-[320px] lg:h-auto'}`}>
