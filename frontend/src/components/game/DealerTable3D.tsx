...
export default function DealerTable3D({
  ...
  return (
    <div className={`flex-1 relative flex flex-col overflow-visible bg-[#050a0d] ${isDT ? 'min-h-[235px] sm:min-h-[300px] lg:min-h-[700px]' : 'min-h-[280px] sm:min-h-[320px] lg:min-h-[700px]'}`}>
