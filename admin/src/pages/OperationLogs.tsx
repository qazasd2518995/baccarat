        ...
        <table className="w-full min-w-[700px]">
          <thead className="bg-[#252525]">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">操作员</th>
              <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">操作</th>
              <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">目标</th>
              <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">IP</th>
            </tr>
          </thead>
